...
let pageSections=["top5", "garlic", "loaded", "ranch", "finder", "visitor"];
...
// Logic for kicking off the visitor validation and form submission
document.addEventListener("DOMContentLoaded", function(){
    initValidation("myForm", "success");
    console.log("End of activating initValidation")
});